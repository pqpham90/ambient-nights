...
/**
 * A list fragment representing a list of Themes. This fragment also supports
...
public class ThemeListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<Menu.Theme>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, Menu.ITEMS));
	}
